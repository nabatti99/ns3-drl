...
OnOffApplication::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::OnOffApplication")
            ...
            .AddTraceSource("SocketTrace",
                            "The socket used by the application",
                            MakeTraceSourceAccessor(&OnOffApplication::m_socketTrace),
                            "ns3::TracedValueCallback::Ptr<Socket>");
    return tid;
}
